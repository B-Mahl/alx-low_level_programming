...
/**
OAOAOA * _strchr - locates character in string
 * @s: string to find character
 * @c: character to find
OAOAOA * Return: found character
 */
OAOAOAchar *_strchr(char *s, char c);
/**
 * _memcpy - copies value from src to dest
OAOAOA * @dest: destination to copy
 * @src: source to copy from
 * @n: amount of times from 0 to copy
OAOAOA * Return: return string char value
 */
...
OAOAOA * @s: string to convert to rot13
